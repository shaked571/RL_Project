...
class DQN(Algo):
    ...
    def __init__(self, gamma, epsilon, lr, input_dims, batch_size, n_actions, env, max_mem_size=100000, eps_end=0.05,
                 eps_dec=5e-4):
        super().__init__(env)
        self.gamma = gamma
        ...
        self.Q_eval = DQNModel(state_dim=input_dims, action_dim=n_actions, hidden_dim=256)
        self.Q_next = DQNModel(state_dim=input_dims, action_dim=n_actions, hidden_dim=256)
